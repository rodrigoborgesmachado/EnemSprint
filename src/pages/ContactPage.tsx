...
export function ContactPage() {
  ...
  const validate = () => {
    ...
    if (trimmed.name.length < 2) {
      nextErrors.name = 'Informe seu nome (mínimo 2 caracteres).'
    }
    if (!emailRegex.test(trimmed.email)) {
      nextErrors.email = 'Informe um e-mail válido.'
    }
    if (trimmed.subject.length < 2) {
      nextErrors.subject = 'Informe um assunto (mínimo 2 caracteres).'
    }
    if (trimmed.message.length < 10) {
      ...
      nextErrors.message = 'A mensagem deve ter no máximo 1000 caracteres.'
    }
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    fetch(CONTACT_API_URL, {
      ...
      .catch((error: unknown) => {
        const message = error instanceof Error ? error.message : 'Serviço indisponível no momento.'
          ...
          <Stack spacing={3}>
            <Stack spacing={1}>
              ...
              <Typography variant="body1" color="text.secondary">
                Fale com a SunSale System pelos canais oficiais abaixo. Respondemos o mais rápido possível em dias úteis.
              </Typography>
            </Stack>
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Se preferir, envie uma mensagem descrevendo sua dúvida e o contexto de uso do EnemSprint.
              </Typography>
                ...
                <Stack component="form" spacing={2} onSubmit={handleSubmit}>
                  ...
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems="center">
                    ...
                    <Typography variant="caption" color="text.secondary">
                      Nós não armazenamos as mensagens no aplicativo. O envio ocorre pela API da SunSale.
                    </Typography>
                  </Stack>
                  {showSuccess ? (
